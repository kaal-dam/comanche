...
/*Renvoie le message complet au client comme au dessus, mais pas les donnees car on s'en occupera juste apres avec la fonction copy et specification du type mime de la ressource demandee*/
